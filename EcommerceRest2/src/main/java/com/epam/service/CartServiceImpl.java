...
public class CartServiceImpl implements CartService {
	...
	@Override
	public CartItem deleteCartItemByCartId(Long cartId) {
		CartItem cartItem = cartItemRepository.findById(cartId).orElseThrow(() -> new DataNotFoundException("CartItem not found"));
