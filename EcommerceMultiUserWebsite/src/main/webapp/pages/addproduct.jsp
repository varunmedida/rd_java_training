...
<!-- swiper CSS -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/price_rangs.css">
<!-- style CSS -->
							...
							<ul class="navbar-nav">
								...
								<li class="nav-item dropdown"><a
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
										...
										<a class="dropdown-item" href="/admin/updatecategory">Update
											Category</a> <a class="dropdown-item" href="/admin/deletecategory">Delete
											Category</a>
									</div></li>
								<li class="nav-item dropdown"><a
									class="nav-link dropdown-toggle" href="#" id="navbarDropdown_1"
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
										...
										<a class="dropdown-item" href="/admin/updateproduct">Update
											Product</a> <a class="dropdown-item" href="/admin/deleteproduct">Delete
											Product</a>
									</div></li>
							</ul>
						</div>
